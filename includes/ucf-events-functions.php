 ...
 */
function today_events_get_layouts( $layouts ) {
	$layouts['modern_date'] = 'Modern Layout, with block dates';
	return $layouts;
}

add_filter( 'ucf_events_get_layouts', 'today_events_get_layouts', 10, 1 );
...
// Modern Date - Before
function today_events_display_modern_date_before( $content, $items, $args, $display_type ) {
	ob_start();
?>
...
add_filter( 'ucf_events_display_modern_date_before', 'today_events_display_modern_date_before', 10, 4 );


// Modern Date - main loop
function today_events_display_modern_date( $content, $items, $args, $display_type, $fallback_message='' ) {
...
add_filter( 'ucf_events_display_modern_date', 'today_events_display_modern_date', 10, 5 );


// Modern Date - after
function today_events_display_modern_date_after( $content, $items, $args, $display_type ) {
	ob_start();
?>
	</div>
<?php
...
add_filter( 'ucf_events_display_modern_date_after', 'today_events_display_modern_date_after', 10, 4 );
